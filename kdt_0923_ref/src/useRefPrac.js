...
export default function UseRefPrac() {
    ...
    const checkValue = () => {
        if(inputWriter.current.value.trim() === '') {
    ...
    return <div>
        <form>
            ...
            <input type="text" id="writer" ref={inputWriter} value={writer} onChange={(e)=> onChange(e)} />
            <label htmlFor="title">제목:</label>
            <input type="text" id="title" ref={inputTitle} onChange={(e) => onChange(e)} />
